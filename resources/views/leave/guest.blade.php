<x-guest-layout>
    ...
    <h2 class="text-xl font-semibold text-gray-800 mb-1">Guest Leave Application</h2>
    <p class="text-sm text-gray-500 mb-6">No account needed &mdash; just fill in your details below.</p>
